...
![](https://img-blog.csdnimg.cn/665beea8d06245f38becde2b28e5bf3c.png)

从这个实验可以看到，这一次“重定向”实际上发送了两次 HTTP 请求，第一个请求返回了 302，然后第二个请求就被重定向到了“/index.html”。但如果不用开发者工具的话，你是完全看不到这个跳转过程的，也就是说，重定向是“用户无感知”的。

我们再来看看第一个请求返回的响应报文：

![](https://img-blog.csdnimg.cn/f9fb7872473a40fd8560a7e4e476750f.png)
...
![](https://img-blog.csdnimg.cn/52af1ad8123d4b76a13824e7737f0f80.png)
...
![](https://img-blog.csdnimg.cn/1cdb7c7a6eb14136b398ff90fc919c56.png)
