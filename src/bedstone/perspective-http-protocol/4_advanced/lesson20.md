...
![](https://img-blog.csdnimg.cn/7cbaf3dadb074f4692d761c2ed2dcca7.png)

你可以访问实验环境的 URI “/20-1”，看看具体的请求 - 应答过程。

![](https://img-blog.csdnimg.cn/631043a641a54daf9d1a6fd5c59db3ca.png)
...
![](https://img-blog.csdnimg.cn/d7915bb206a74e5b9d8cdc43df7abaf4.png)
...
但这样的两个请求网络成本太高了，所以 HTTP 协议就定义了**一系列“If”开头的“条件请求”字段**，专门用来检查验证资源是否过期，把两个请求才能完成的工作合并在一个请求里做。而且，验证的责任也交给服务器，浏览器只需“坐享其成”。
...
![](https://img-blog.csdnimg.cn/c51ccf7895754170843dad5cedcf79f5.png)
